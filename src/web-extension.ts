...
import { activateTypeScriptDebug } from './activateMockDebug';

export function activate(context: vscode.ExtensionContext) {
	activateTypeScriptDebug(context);	// activateMockDebug without 2nd argument launches the Debug Adapter "inlined"
}
